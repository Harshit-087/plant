    ...
    return(
      <>
        ...
        <nav className="relative z-50 w-screen  p-2 flex justify-evenly items-center  ">
           <div className=" w-[10%] max-lg:w-[5%] rounded-full h-[3rem] flex justify-center items-center "> 
            <Image src="/images/logo.png" alt="logo" width={60} height={50} className="lg:scale-[1.5] max-lg:scale-[1.2]" />
              </div>
           <div className="flex justify-evenly lg:text-[1rem] w-[60%] m-4 max-lg:text-sm max-lg:gap-3 max-lg:[70%]">
        ...
        <div className="w-16 max-lg:w-10"> <p className="w-[6rem] max-lg:w-[4rem] max-lg:hidden max-lg:px-2 max-lg:py-1 max-lg:text-xs max-lg:mx-2 h-[2rem] text-sm text-white border-white border-2   rounded-full flex justify-center items-center">SIGN IN</p></div>
          <div className="relative">
  <div
    onClick={handleOpen}
    className="w-8 h-8 max-lg:w-6 max-lg:h-6 z-0 max-lg:scale-[1.15]  max-xl:ml-4  border-white border-2 rounded-full flex justify-center items-center scale-[1.25] cursor-pointer"
  >
    🧞
  </div>
     ...
     <ul>
      <li className="w-4 leading-5 whitespace-nowrap text-sm text-black">SIGN IN</li>
       ...
       <div className=" w-screen ">
         <h1 className="text-8xl text-center scale-[1.75] max-lg:scale-[1.45]">greenspire</h1>
       </div>
