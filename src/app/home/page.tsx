...
const Home=()=>{
    ...
    return(
      <>
        ...
        <div className="min-h-screen w-screen bg-[radial-gradient(circle_at_50%_20%,_#5f8d5f_0%,_#3a593a_10%,_#1f2e1f_30%)] text-white ">
        ...
        <div className="w-[10%] "> <p className="w-[6rem]  h-[2rem] text-sm text-white border-white border-2   rounded-full flex justify-center items-center">SIGN IN</p></div>
