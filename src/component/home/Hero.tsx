...
function Hero() {
  return (
    ...
    <div className=" w-screen h-[20%] flex justify-evenly gap-2 items-center ">
         <div className="border-white  border-b-2 w-[50%] "></div>
        ...
        <div className="w-screen h-[90%] grid grid-cols-3  mt-28 gap-4 ">
            ...
            <div className=" flex flex-col gap-8 p-4 m-8 justify-center items-center text-black ">
                ...
                <div className="w-[80%] h-[35%] rounded-2xl border-2 border-gray flex  justify-center gap-2  ">
                    ...
                    <div className=" w-[60%] h-full m-4 flex flex-col">
                        <h3 className="text-white font-bold">Garden croton</h3>
                     ...
                     <p className="texxt-2xl  text-right text-white ">Rs 199/-</p>
                ...
                <div className="w-[80%] h-[35%] rounded-2xl border-2 border-gray flex  justify-center gap-2  ">
                    ...
                    <div className=" w-[60%] h-full m-4 flex flex-col">
                        <h3 className="text-white font-bold">Dwarf umbrella</h3>
                         <p className="text-sm text-right text-gray-200">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo praesentium reiciendis, ip  </p>
            ...
            <div className=" flex flex-col gap-8 p-4 m-8 justify-center items-center">
              <div className="w-[80%] h-[35%] rounded-2xl border-2 border-gray flex  justify-center gap-2  ">
                    ...
                    <div className=" w-[60%] h-full m-4 flex flex-col">
                        <h3 className="text-white font-bold">Fiddle leaf-fig</h3>
                          <p className="text-sm text-right text-gray-200">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo praesentium reiciendis, ip  </p>
                ...
                <div className="w-[80%] h-[35%] rounded-2xl border-2 border-gray flex  justify-center gap-2  ">
                    ...
                    <div className=" w-[60%] h-full m-4 flex flex-col">
                        <h3 className="text-white font-bold">Bird of paradise</h3>
                          <p className="text-sm text-right text-gray-200">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo praesentium reiciendis, ip  </p>
                    <p className="texxt-2xl  text-right ">Rs 199/-</p>
                   <button className="bg-white rounded-2xl text-black w-[5rem] h-[2rem] ">Buy Now</button>
                    </div>
                ...
                <div className="w-[80%] h-[35%] rounded-2xl border-2 border-gray flex  justify-center gap-2  ">
                    ...
                    <div className=" w-[60%] h-full m-4 flex flex-col">
                        <h3 className="text-white font-bold">Dragon tree</h3>
                        <p className="text-sm text-right text-gray-200">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo praesentium reiciendis, ip  </p>
                     <p className="texxt-2xl  text-right ">Rs 199/-</p>
                   <button className="bg-white rounded-2xl text-black w-[5rem] h-[2rem] ">Buy Now</button>
                    </div>
           ...
           <div className="w-full  flex flex-col text-green ">
            ...
            <div className=" p-4 m-8 flex flex-col gap-8 justify-center items-center">
                ...
                <div className="w-[80%] h-[35%] rounded-2xl border-2 border-gray flex  justify-center gap-2  ">
                    ...
                    <div className=" w-[60%] h-full m-4 flex flex-col">
                        <h3 className="text-white font-bold">Algaonema red</h3>
                          <p className="text-sm text-right text-gray-200">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo praesentium reiciendis, ip  </p>
                     <p className="texxt-2xl  text-right ">Rs 199/-</p>
                   <button className="bg-white rounded-2xl text-black w-[5rem] h-[2rem] ">Buy Now</button>
                    </div>
