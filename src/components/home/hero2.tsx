  ...
  return (
    <>
     <div className=" w-screen h-4 flex justify-evenly gap-2  items-center mt-24 ">
         ...
         <h1 className="text-6xl text-center whitespace-nowrap max-lg:text-5xl">How to train your free plant</h1>
         <div className="border-white  border-b-2 w-96 "></div>
        </div>

        <div className=' h-[45rem] w-screen    '>
          <div className='w-[55rem] h-[37rem] max-lg:w-[40rem] max-lg:h-[32rem] xl:w-[70rem]  relative inset-0 rounded-[5rem]  bg-[radial-gradient(circle_at_right,_#142518_12%,_#324733_40%,_#72916D_50%,_#8FB287_60%,#D2FFC3_100%)]   mx-auto mt-20 flex overflow-hidden'>
            ...
            <span className="w-full  font-bold  pl-6">Sign up with your mobile number
              <ul className='font-normal list-disc max-lg:text-sm'>
            ...
            <div className="text-lg font-bold flex">
              <span className='rounded-full w-8 h-8 my-auto bg-black text-white  flex justify-center items-center p-1'>02. </span>
               <span className="w-full font-bold pl-6">Browse & Choose Your Plant
                <ul className='list-disc font-normal max-lg:text-sm'>
            ...
            <div className=" absolute top-0 right-0 ">
                  <Image src="/images/plant2.png" alt="#" width={600} height={100}  className='scale-[0.75] translate-x-12 max-lg:scale-[0.50] max-lg:translate-x-36 '/>
                </div>
