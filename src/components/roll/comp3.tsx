...
const Comp3 = () => {
  return (
   <>
    ...
    <div  className='w-full flex flex-col bg-[radial-gradient(ellipse_at_left,_#72916D,_#203625)] px-2 py-2 rounded-b-lg rounded-r-lg'>
        <h1 className='font-bold text-xl w-full flex gap-2  items-center'>pradeep.
